...
@router.get("/{employee_code}", dependencies=[Depends(require_role(["org_admin", "manager", "employee"]))])
...
@router.put("/{employee_code}", dependencies=[Depends(require_role(["org_admin", "manager"]))])
