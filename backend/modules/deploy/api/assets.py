...
@router.get("/{employee_code}", dependencies=[Depends(require_permission("deploy.assets.view_personal"))])
...
@router.put("/{employee_code}", dependencies=[Depends(require_permission("deploy.assets.manage_onboarding"))])
