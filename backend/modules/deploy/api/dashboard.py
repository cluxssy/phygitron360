...
@router.get("/stats", dependencies=[Depends(require_role(["org_admin", "manager", "super_admin"]))])
...
@router.get("/employee-stats", dependencies=[Depends(require_role(["employee", "manager", "org_admin", "super_admin"]))])
