...
class NotificationService:
    ...
    def get_user_notifications(self, employee_code: str, limit: int = 10, unread_only: bool = False):
        return self.repo.get_notifications_for_user(employee_code, self.tenant_id, limit, unread_only)
    ...
    def mark_all_read(self, employee_code: str, is_admin: bool = False):
        self.repo.mark_all_as_read(employee_code, is_admin, self.tenant_id)

    def get_unread_count(self, employee_code: Optional[str], is_admin: bool = False):
        return self.repo.get_unread_count(employee_code, is_admin, self.tenant_id)
