...
# Use Data Source to get available Availability Zones
data "aws_availability_zones" "available" {}

# Public Subnets (For ALB and ECS Tasks so they can pull from ECR without NAT Gateway)
...
resource "aws_ecr_repository" "backend" {
  name                 = "phygitron-backend"
  image_tag_mutability = "MUTABLE"
}

resource "aws_ecr_repository" "frontend" {
  name                 = "phygitron-frontend"
  image_tag_mutability = "MUTABLE"
}
